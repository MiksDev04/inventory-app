...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        $stmt = $pdo->prepare("UPDATE items SET sku = ?, name = ?, description = ?, category_id = ?, supplier_id = ?, quantity = ?, unit_price = ?, reorder_level = ? WHERE id = ?");
        ...
        $stmt->execute([
            ...
            $_POST['unit_price'],
            $_POST['reorder_level'],
            $_POST['id'] // Assuming the item ID is passed in the URL
        ]);
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0 text-primary fw-bold">
                    <i class="bi bi-box-seam me-2"></i>Update Item
                </h1>
                <p class="text-muted mb-0">Update the item in your inventory</p>
            </div>
            <div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text"
                                ...
                                value="<?= isset($item['sku']) ? htmlspecialchars($item['sku']) : '' ?>"
                                required>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description"
                                ...
                                class="form-control"
                                rows="3"
                                placeholder="Detailed description of the item..."><?= isset($item['description']) ? htmlspecialchars($item['description']) : '' ?></textarea>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number"
                                ...
                                min="0"
                                placeholder="0"
                                value="<?= isset($item['quantity']) ? htmlspecialchars($item['quantity']) : '' ?>"
                                required>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number"
                                    ...
                                    step="0.01"
                                    placeholder="0.00"
                                    value="<?= isset($item['unit_price']) ? htmlspecialchars($item['unit_price']) : '' ?>"
                                    required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number"
                                ...
                                min="0"
                                placeholder="10"
                                value="<?= isset($item['reorder_level']) ? htmlspecialchars($item['reorder_level']) : '' ?>"
                                required>
